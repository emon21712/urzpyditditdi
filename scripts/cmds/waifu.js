	...
	onStart: async function ({ message, args }) {
		...
		if (!name)
			...
			try {
				...
				message.reply(form);
			} catch (e) { message.reply(` No waifu  \ategory: waifu, neko, shinobu, megumin, bully, cuddle, cry, kiss, lick, hug, awoo, pat, smug, bonk, yeet, blush, smile, wave, highfive, handhold, nom, bite, glomp, slap, kill, kick, happy, wink, poke, dance, cringe `) }
