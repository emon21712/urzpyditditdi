...
const doNotDelete ="「Captain-NemO」";
/** 
* @author NTKhang
...
╰───────────⭔
╭───⭔『 GAME 』
│✧bal ✧guessnumber ✧daily
│✧quiz ✧slot ✧quiz2 ✧rank
│✧Sicbo ✧bank ✧richest
│✧dhbc ✧rps ✧wordgame
│✧tod ✧country ✧ttt(with bot)
│✧choose ✧coinflip ✧tod
│✧pokebot ✧pokedex ✧pet
│✧pokechamps ✧ pokespawn
╰───────────⭔
╭───⭔『 IMAGE 』
│✧slap ✧buttslap ✧bed
│✧affect ✧arrest ✧hell
...
╰───────────⭔ 
╭───⭔『ANIGC』
│ Type !anigc to join gc. 
│ use callad command to ask 
│help.
│ » Total cmds: [ %4 ].
│ Type: [%5help to 
│<cmd> ] to learn
